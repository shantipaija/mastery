...
add_action( 'add_meta_boxes', 'mastery_add_custom_box' );
/**
 * Add Meta Boxes.
 *
 * Add Meta box in page and post post types.
 */
function mastery_add_custom_box() {
	add_meta_box('siderbar-layout', //Unique ID
		__( 'Select layout for this specific Page only.', 'mastery' ), //Title
		'mastery_sidebar_layout', //Callback function
		'page' //show metabox in pages
	);
	add_meta_box('siderbar-layout', //Unique ID
		__( 'Select layout for this specific Post only', 'mastery' ), //Title
		'mastery_sidebar_layout', //Callback function
	...
	if ( class_exists( 'WooCommerce' ) ) {
		add_meta_box('product-siderbar-layout', //Unique ID
			__( 'Select layout for this specific Product only', 'mastery' ), //Title
			'mastery_sidebar_layout', //Callback function
 ...
 */
function mastery_sidebar_layout() {
...
add_action( 'save_post', 'mastery_save_custom_meta' );
/**
 * save the custom metabox data
 * @hooked to save_post hook
 */
function mastery_save_custom_meta( $post_id ) {
	global $site_layout, $post;
