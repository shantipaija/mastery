jQuery( document ).ready(function() {
    var mediaControl = {
        ...
        select: function() {
            ...
            var selector = jQuery( '.mastery-media-container' ).find( mediaControl.selector );
            var data = {
                action: 'mastery_get_attachment_media',
                attachment_id: id
            };
            ...
            jQuery.post( mastery.ajaxurl, data, function( response ) {
        ...
        init: function() {
            ...
            context.on( 'click', '.mastery-media-container .upload-button', function( e ) {
                var container = jQuery( this ).parents( '.mastery-media-container' ),
            ...
            context.on( 'click', '.mastery-media-container .remove-button', function( e ) {
                var container = jQuery( this ).parents( '.mastery-media-container' ),
                    sibling = container.find( 'input' ),
